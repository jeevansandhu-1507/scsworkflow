...
public static class Catalog
{
    ...
    public static readonly string[] MccssFundingTypeChoices =
    {
        ...
        "Temporary Funding Allocation (Adult) - English",
        "Temporary Funding Allocation (Adult) - French",
        "Temporary Flexible Funding Allocation (Adult) - English",
        "Temporary Flexible Funding Allocation (Adult) - French",
