...
public static class GlMappingService
{
    ...
    public static string NormalizeFundingType(string? raw)
    {
        ...
        if (clean.Equals("Passport Funding", StringComparison.OrdinalIgnoreCase) || 
            ...
            clean.Equals("Passport One (Family Services Ontario)", StringComparison.OrdinalIgnoreCase) ||
            clean.Equals("Passport One", StringComparison.OrdinalIgnoreCase))
    ...
    public static List<SupportTypeCompat> SupportTypes { get; } = new()
    {
        ...
        new() { Name = "Individualized Staffing", GlCode = 5020, Description = "Extra staff support at a specific ratio (for example, 1:1 or 2:1) to meet individual needs.", CompatibleFundingTypes = new() { "Temporary Funding Allocation - Complex Special Needs (CSN)", "MCCSS Fiscal Residential Funding Allocation", "Passport" } },
        ...
        new() { Name = "Structured Seasonal Programs", GlCode = 5530, Description = "Time‑limited programs such as day camps, summer camps, or seasonal retreats.", CompatibleFundingTypes = new() { "Temporary Funding Allocation - Complex Special Needs (CSN)", "Temporary Funding Allocation - Children's", "Temporary Funding -Autism Spectrum Disorder (ASD) Allocation", "MCCSS Fiscal Community Participation Funding Allocation", "Passport" } },
    ...
    public static List<CommitmentGlMapping> CommitmentMappings { get; } = new()
    {
        ...
        new() { FundingType = "MCCSS Fiscal Residential Funding Allocation", PlanType = null, FundingStatus = "Permanent", SupportType = "Prescription Medication/Supplies", PlacementType = null, GlCode = 5240, GlName = "Prescription Medication/Supplies", AccountId = "72899000000125566" },
        new() { FundingType = "MCCSS Fiscal Residential Funding Allocation", PlanType = null, FundingStatus = "Permanent", SupportType = "Presciption Medication/Supplies", PlacementType = null, GlCode = 5240, GlName = "Prescription Medication/Supplies", AccountId = "72899000000125566" },
        ...
        new() { FundingType = "MCCSS Fiscal Residential Funding Allocation", PlanType = null, FundingStatus = "Permanent", SupportType = "Presciption Medication/Supplies", PlacementType = "Group Home", GlCode = 5241, GlName = "Prescription Medication/Supplies-GH", AccountId = "72899000000125566" },
        ...
        new() { FundingType = "MCCSS Fiscal Residential Funding Allocation", PlanType = null, FundingStatus = "Permanent", SupportType = "Presciption Medication/Supplies", PlacementType = "Host Family", GlCode = 5242, GlName = "Prescription Medication/Supplies-HF", AccountId = "72899000000125578" },
        ...
        new() { FundingType = "MCCSS Fiscal Residential Funding Allocation", PlanType = null, FundingStatus = "Permanent", SupportType = "Presciption Medication/Supplies", PlacementType = "Specialized Accommodation", GlCode = 5243, GlName = "Prescription Medication/Supplies-SA", AccountId = "72899000000125572" },
        ...
        new() { FundingType = "MCCSS Fiscal Residential Funding Allocation", PlanType = null, FundingStatus = "Permanent", SupportType = "Presciption Medication/Supplies", PlacementType = "Supported Independent Living (SIL)", GlCode = 5244, GlName = "Prescription Medication/Supplies-SIL", AccountId = "72899000000125584" },
        ...
        new() { FundingType = "Temporary Funding Allocation - Complex Special Needs (CSN)", PlanType = null, FundingStatus = "Temporary", SupportType = "Presciption Medication/Supplies", PlacementType = null, GlCode = 5245, GlName = "Prescription Medication/Supplies-CSN", AccountId = "72899000000125590" },
        ...
        new() { FundingType = "Temporary Funding  Allocation- Community Enhancement (CEF)", PlanType = null, FundingStatus = "Temporary", SupportType = "Presciption Medication/Supplies", PlacementType = null, GlCode = 5246, GlName = "Prescription Medication/Supplies-CEF for CSN", AccountId = "72899000000125596" },
        ...
        new() { FundingType = "Temporary Funding Allocation - Complex Special Needs (CSN)", PlanType = null, FundingStatus = "Temporary", SupportType = "Assessment", PlacementType = null, GlCode = 5230, GlName = "Assessments-CSN", AccountId = "72899000000125600" },
    ...
    public static List<InvoiceGlMapping> InvoiceMappings { get; } = new()
    {
        ...
        new() { FundingType = "Temporary Funding Allocation - Complex Special Needs (CSN)", FundingStatus = "Temporary", SupportType = "Assessment", PlacementType = null, GlCode = 5230, GlName = "Assessments-CSN", AccountId = "72899000000125600" },
        ...
        new() { FundingType = "MCCSS Fiscal Residential Funding Allocation", FundingStatus = "Permanent", SupportType = "Prescription Medication/Supplies", PlacementType = null, GlCode = 5240, GlName = "Prescription Medication/Supplies", AccountId = "72899000000125566" },
        new() { FundingType = "MCCSS Fiscal Residential Funding Allocation", FundingStatus = "Permanent", SupportType = "Presciption Medication/Supplies", PlacementType = null, GlCode = 5240, GlName = "Prescription Medication/Supplies", AccountId = "72899000000125566" },
        ...
        new() { FundingType = "MCCSS Fiscal Residential Funding Allocation", FundingStatus = "Permanent", SupportType = "Presciption Medication/Supplies", PlacementType = "Group Home", GlCode = 5241, GlName = "Prescription Medication/Supplies-GH", AccountId = "72899000000125566" },
        ...
        new() { FundingType = "MCCSS Fiscal Residential Funding Allocation", FundingStatus = "Permanent", SupportType = "Presciption Medication/Supplies", PlacementType = "Host Family", GlCode = 5242, GlName = "Prescription Medication/Supplies-HF", AccountId = "72899000000125578" },
        ...
        new() { FundingType = "MCCSS Fiscal Residential Funding Allocation", FundingStatus = "Permanent", SupportType = "Presciption Medication/Supplies", PlacementType = "Specialized Accommodation", GlCode = 5243, GlName = "Prescription Medication/Supplies-SA", AccountId = "72899000000125572" },
        ...
        new() { FundingType = "MCCSS Fiscal Residential Funding Allocation", FundingStatus = "Permanent", SupportType = "Presciption Medication/Supplies", PlacementType = "Supported Independent Living (SIL)", GlCode = 5244, GlName = "Prescription Medication/Supplies-SIL", AccountId = "72899000000125584" },
        ...
        new() { FundingType = "Temporary Funding  Allocation- Community Enhancement (CEF)", FundingStatus = "Temporary", SupportType = "Presciption Medication/Supplies", PlacementType = null, GlCode = 5246, GlName = "Prescription Medication/Supplies-CEF for CSN", AccountId = "72899000000125596" },
        new() { FundingType = "Temporary Funding Allocation - Complex Special Needs (CSN)", FundingStatus = "Temporary", SupportType = "Prescription Medication/Supplies", PlacementType = null, GlCode = 5245, GlName = "Prescription Medication/Supplies-CSN", AccountId = "72899000000125590" },
        new() { FundingType = "Temporary Funding Allocation - Complex Special Needs (CSN)", FundingStatus = "Temporary", SupportType = "Presciption Medication/Supplies", PlacementType = null, GlCode = 5245, GlName = "Prescription Medication/Supplies-CSN", AccountId = "72899000000125590" },
    ...
    public static GlMappingResult? GetGlMappingForCommitment(string fundingType, string planType, string fundingStatus, string supportType, string? placementType)
    {
        ...
        bool isUnrestrictedSupport = string.IsNullOrEmpty(supportType) ||
                                     supportType.Equals("Unrestricted Planning Accounts", StringComparison.OrdinalIgnoreCase) ||
                                     supportType.Equals("None", StringComparison.OrdinalIgnoreCase) ||
                                     supportType.Equals("None Specified", StringComparison.OrdinalIgnoreCase) ||
                                     supportType.Equals("N/A", StringComparison.OrdinalIgnoreCase) ||
                                     supportType.Equals("Unrestricted Allocation", StringComparison.OrdinalIgnoreCase);

        if (normPlan.Equals("Unrestricted", StringComparison.OrdinalIgnoreCase) && isUnrestrictedSupport)
        {
